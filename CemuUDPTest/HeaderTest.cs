...
public class Tests
{
    ...
    {
        byte[] msg = new byte[] { 0x44, 0x53, 0x55, 0x43, 0xE9, 0x03, 0x0C, 0x00, 0x9F, 0x0A, 0x18, 0x86, 0x75, 0xD7, 0xD7, 0xA3, 0x02, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }; var header = Header.DecodeClientHeader(msg); Assert.IsTrue(header != null);
